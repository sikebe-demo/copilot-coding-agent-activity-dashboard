...
The dashboard identifies PRs created by Copilot Coding Agent using the following signals (logical **OR**):

- **GitHub logins**: exact matches for `github-copilot`, `copilot-workspace-helper`, `github-copilot-preview[bot]`
- **Labels**: PRs labeled `copilot`, `copilot-generated`, or `github-copilot`
- **Body/title signatures**: phrases such as "generated by GitHub Copilot", "created by GitHub Copilot", or "GitHub Copilot Workspace"
