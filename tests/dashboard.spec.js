...
test.describe('Copilot Coding Agent PR Dashboard', () => {
      ...
      const prs = [
        {
          ...
          user: { login: 'github-copilot', type: 'Bot' },
        ...
        },
        {
          ...
          user: { login: 'copilot-workspace-helper', type: 'Bot' },
  ...
  test('should only treat explicit Copilot signals as Copilot PRs', async ({ page }) => {
    const now = new Date();
        ...
        body: JSON.stringify([
          {
            ...
            user: { login: 'user-copilot-enthusiast', type: 'User' },
    ...
    await expect(prList).toContainText('#12');
    await expect(prList).not.toContainText('#11');
  });
